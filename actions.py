...
class ItemAction(Action):
    ...
    def target_actor(self) -> Optional[Actor]:
        return self.engine.game_map.get_blocking_entity_at_location(*self.target_xy)
...
class ActionWithDirection(Action):
    ...
    # Return the entity blocking this action's destinatin
    @property
...
class MovementAction(ActionWithDirection):
    def perform(self) -> None:
        ...
        # Return before moving if desination is out of bounds or unwalkable or blocked
